/*
  ...
  - You are about to drop the column `dt_register` on the `silo` table. All the data in the column will be lost.
  - You are about to drop the column `sensor_value` on the `silo` table. All the data in the column will be lost.
  - You are about to drop the column `silo_name` on the `silo` table. All the data in the column will be lost.
  - Added the required column `sensorCode` to the `silo` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "public"."silo" DROP COLUMN "dt_register",
DROP COLUMN "sensor_value",
DROP COLUMN "silo_name",
